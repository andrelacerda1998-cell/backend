...
return [
    ...
    */
    'commands' => [
        'About' => './vendor/bin/sail php artisan solo:about',
        'Logs' => EnhancedTailCommand::file(storage_path('logs/laravel.log')),
        'Vite' => './vendor/bin/sail yarn dev',
        'Make' => new MakeCommand,
        // 'HTTP' => 'php artisan serve',

        // Lazy commands do not automatically start when Solo starts.
        'Dumps' => Command::from('./vendor/bin/sail php artisan solo:dumps'),
        'Reverb' => Command::from('./vendor/bin/sail php artisan reverb:start --debug'),
        'Pint' => Command::from('./vendor/bin/pint --ansi')->lazy(),
        'Queue' => Command::from('./vendor/bin/sail php artisan queue:work'),
    ],

...
class OpenServiceController extends Controller
{
    ...
    private function processCreditCardPayment($customer, $service, $vendor, $total, $paymentMethod): ?string
    {
        $validationUrl = null;
    ...
    private function processMbwayPayment(User $customer, Service $service, Vendor $vendor, $total, PaymentMethod $paymentMethod): ?string
    {
        $validationUrl = null;
